...
// 1.1、先判断有缴款记录，不能删除。要先删除缴款记录fee
$sql = "SELECT 1 FROM `ghjy_accnt_fee` Where accntID=$accntID";
...
// 1.2、判断子表记录是否已经分班（或一对一排课）isClassed，如果是，不能删除
